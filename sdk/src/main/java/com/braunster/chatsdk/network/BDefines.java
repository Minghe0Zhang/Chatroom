...
public class BDefines {
    ...
    public static final String BRootPath = "test/";
    ...
    public static String ServerUrl = "https://chat-cs6250-2017.firebaseio.com/" + BRootPath;

    /** The url that is used for the file uploads.*/
    public static String FirebaseStoragePath = "gs://chat-cs6250-2017.appspot.com";
